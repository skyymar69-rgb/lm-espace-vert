// Source de vérité unique pour les liens externes / réseaux sociaux.
// ⚠️ À CONFIRMER : le handle Instagram était incohérent dans le code
// (lm_espacevert vs lm_espace_vert). Unifié sur lm_espacevert (valeur des données
// structurées). Corriger ici si le vrai compte diffère.
