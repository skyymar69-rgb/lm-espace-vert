        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            {badges.map(({ icon: Icon, label }) => (
              ...
              >
                <Icon size={16} style={{ color: '#275524' }} aria-hidden="true" />
                {label}
              </div>
            ))}
          </div>
              ...
              <form className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Jean"
                        required
                        className="border border-[--color-border] rounded-xl px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-[#275524]/20 focus:border-[#275524]"
                      />
                    </div>
                    <div>
                    ...
                    {[
                      ...
                      <label key={service} className="flex items-center gap-3 cursor-pointer group">
                        <input
                          ...
                          name="services"
                          value={service}
                          className="w-4 h-4 rounded accent-[#275524] cursor-pointer"
                        />
                        <span className="text-sm text-[--color-fg] group-hover:text-[#275524] transition-colors">
                          {service}
                        </span>
                      </label>
                    ))}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      id="surface"
                      name="surface"
                      className="border border-[--color-border] rounded-xl px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-[#275524]/20 focus:border-[#275524] bg-white"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="border border-[--color-border] rounded-xl px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-[#275524]/20 focus:border-[#275524] resize-none"
                  />
                </div>
            ...
            <div>
              ...
              <ul role="list" className="space-y-4">
                {guarantees.map(({ icon: Icon, text }) => (
                  <li key={text} className="flex items-start gap-4">
                    <div className="mt-0.5 flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center" style={{ backgroundColor: '#275524' + '18' }}>
              ...
              <div className="mt-8 rounded-2xl p-6 bg-[--color-green-light]">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <Phone size={16} style={{ color: '#275524' }} aria-hidden="true" />
                    +33 (0)X XX XX XX XX
                  </a>
                  <a
                    ...
                    className="flex items-center gap-3 text-sm font-medium text-[--color-fg] hover:underline"
                  >
                    <MessageCircle size={16} style={{ color: '#275524' }} aria-hidden="true" />
              ...
              <div className="mt-6 rounded-2xl border border-[--color-border] bg-white p-6 shadow-sm">
                <div className="flex gap-1 mb-3">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={14} fill="#275524" style={{ color: '#275524' }} aria-hidden="true" />
                  ))}
                </div>
