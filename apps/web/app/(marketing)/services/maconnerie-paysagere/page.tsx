    ...
    <>
      ...
      <section className="relative h-[50vh] min-h-[380px] flex items-end" aria-labelledby="service-heading">
        ...
        <div className="relative container mx-auto max-w-7xl px-4 sm:px-6 pb-14">
          <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#9E4B47' }}>Aménagements minéraux</p>
      ...
      <section style={{ backgroundColor: '#243238' }} className="py-20 text-center">
        <div className="container mx-auto max-w-xl px-4 sm:px-6">
          ...
          <h2 className="font-display text-[clamp(1.75rem,3.5vw,2.75rem)] font-bold text-white mb-4">Votre projet maçonnerie, on en parle ?</h2>
