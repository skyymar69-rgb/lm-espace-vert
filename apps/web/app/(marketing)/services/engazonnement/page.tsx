...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://www.lmespacevert.fr/images/blog-gazon-rouleau.webp', width: 1200, height: 630, alt: 'CrÃ©ation de pelouse par engazonnement Ã  Lyon nord â€” LM Espace Vert' }],
  },
  twitter: {
