...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/realisations`,                lastModified: now, changeFrequency: 'weekly',  priority: 0.85 },
    ...
    { url: `${BASE_URL}/a-propos`,                    lastModified: now, changeFrequency: 'yearly',  priority: 0.7 },
