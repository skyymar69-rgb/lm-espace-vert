...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/galerie`,                     lastModified: now, changeFrequency: 'weekly',  priority: 0.8 },
    ...
    // Zones d'intervention (secteurs) — slugs alignés sur les routes réelles
    ...
    { url: `${BASE_URL}/secteur/neuville`,             lastModified: now, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE_URL}/secteur/craponne`,             lastModified: now, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE_URL}/secteur/francheville`,         lastModified: now, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE_URL}/secteur/saint-cyr`,            lastModified: now, changeFrequency: 'monthly' as const, priority: 0.78 },
    { url: `${BASE_URL}/secteur/collonges`,            lastModified: now, changeFrequency: 'monthly' as const, priority: 0.78 },
    { url: `${BASE_URL}/secteur/charbonnieres`,        lastModified: now, changeFrequency: 'monthly' as const, priority: 0.78 },
    { url: `${BASE_URL}/secteur/curis`,                lastModified: now, changeFrequency: 'monthly' as const, priority: 0.75 },
    { url: `${BASE_URL}/secteur/albigny`,              lastModified: now, changeFrequency: 'monthly' as const, priority: 0.75 },
